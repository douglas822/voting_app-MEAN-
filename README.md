...
## Voting application using MEAN stack
This application is built from MEAN stack.
MEAN stack is really a good tool for developing a fast, robust, and extensible Website.
* Mean.js(https://github.com/meanjs/mean.git)-is a extraordinary good boilerplate to start with. This app has been stemed from that boilerplate.
...
```bash
$ git clone https://github.com/douglas822/voting_app-MEAN-.git vote_app
```
